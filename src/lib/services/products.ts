...
const fallbackCategories = [
  { id: "cat-001", name: "Electronics", slug: "electronics", description: "Gadgets and devices", image_url: null, parent_id: null, sort_order: 1, created_at: new Date().toISOString() },
  { id: "cat-002", name: "Fashion", slug: "fashion", description: "Apparel and accessories", image_url: null, parent_id: null, sort_order: 2, created_at: new Date().toISOString() },
  { id: "cat-003", name: "Home & Living", slug: "home-living", description: "Home essentials", image_url: null, parent_id: null, sort_order: 3, created_at: new Date().toISOString() },
];
...
const fallbackProducts = [
  {
    ...
    product_images: [{ id: "img-001", product_id: "prod-001", image_url: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=600&fit=crop", sort_order: 1, alt_text: null }],
  ...
  },
  {
    ...
    description: "Genuine leather jacket with a tailored fit.",
    category_id: "cat-002",
    vendor_id: null,
    price: 499.99,
    sale_price: 399.99,
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    product_images: [{ id: "img-002", product_id: "prod-002", image_url: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=600&h=600&fit=crop", sort_order: 1, alt_text: null }],
  ...
  },
  {
    ...
    description: "A curated set of premium scented candles.",
    category_id: "cat-003",
    vendor_id: null,
    price: 49.99,
    sale_price: 39.99,
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    product_images: [{ id: "img-003", product_id: "prod-003", image_url: "https://images.unsplash.com/photo-1603006905003-be475563bc59?w=600&h=600&fit=crop", sort_order: 1, alt_text: null }],
