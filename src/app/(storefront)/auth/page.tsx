            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border px-2 py-3 text-xs font-medium transition-all ${accountType === option.key ? "border-primary bg-primary/10 text-primary" : "border-border text-foreground-secondary hover:bg-muted"}`}
                >
